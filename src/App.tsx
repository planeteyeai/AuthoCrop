        ...
        <main className={`flex-1 transition-all duration-300 ease-in-out ml-0 ${
          ...
          <div className="w-full h-full">
            ...
            {currentView === View.userList && (
              ...
              currentUserRole={currentUser.role as 'owner' | 'manager' | 'fieldofficer' | 'farmer'} 
              />
            )}
          ...
          {currentView === View.Calendar && <Calendar  currentUserId={currentUser.id}
          ...
          {currentView === View.TaskCalendar && currentUser && (
            ...
            {currentView === View.ViewList && <ViewList currentUserId={currentUser.id}
                currentUserRole={currentUser.role as 'manager' | 'fieldofficer' | 'farmer'}
