...
import { BarChart3, Users, Calendar, Users as TeamConnect, Truck, Cloud, Book } from 'lucide-react';
...
const menuItems = [
  ...
  { title: 'Harvesting Planning', icon: <GiSugarCane size={32} className="text-yellow-600" />, bgColor: 'bg-yellow-50', hoverColor: 'hover:bg-yellow-100' },
  { title: 'Agroclimatic', icon: <Cloud size={32} className="text-cyan-600" />, bgColor: 'bg-cyan-50', hoverColor: 'hover:bg-cyan-100' },
  { title: 'User Desk', icon: <Users size={32} className="text-purple-600" />, bgColor: 'bg-purple-50', hoverColor: 'hover:bg-purple-100' },
  { title: 'MyTask', icon: <Calendar size={32} className="text-green-600" />, bgColor: 'bg-green-50', hoverColor: 'hover:bg-green-100' },
  { title: 'Team Connect', icon: <TeamConnect size={32} className="text-pink-600" />, bgColor: 'bg-pink-50', hoverColor: 'hover:bg-pink-100' },
  { title: 'Resources Planning', icon: <Truck size={32} className="text-orange-600" />, bgColor: 'bg-orange-50', hoverColor: 'hover:bg-orange-100' },
